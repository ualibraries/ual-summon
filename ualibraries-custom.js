$(document).ready(function() {
   ...
   */
  $('<link rel="stylesheet" href="//webdev.library.arizona.edu/vendor-support/summon/ualibraries-custom.css?ver=031914-1">').appendTo( $('head') );
 
  /**
   * Add a feedback link
   */
  $('<a class="feedback-link" target="_blank" style="display: block; position: fixed; right: 20px; bottom: 20px;" href="http://www.library.arizona.edu/search-find/summon/feedback">Submit Feedback</a>').appendTo('.search');
