$(document).ready(function() {
   ...
   * Add a feedback link
   */
  $('<a class="feedback-link" target="_blank" href="http://www.library.arizona.edu/search-find/summon/feedback">Submit Feedback<span class="feedback-dismiss-button"></span></a>').appendTo('.search');
